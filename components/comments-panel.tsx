...
import { MessageSquare, Eye, EyeOff, Calendar, MapPin, ChevronRight, ChevronDown } from "lucide-react"
                    ...
                    <CardHeader className="pb-2">
                      <div className="flex items-start justify-between">
                        ...
                        <Button
                          ...
                          onClick={(e) => {
                            e.stopPropagation()
                            onToggleCommentVisibility(comment.id)
                          }}
                        >
                          {comment.isVisible ? <Eye className="h-4 w-4" /> : <EyeOff className="h-4 w-4" />}
                        </Button>
                      </div>
                    </CardHeader>
                    <CardContent className="pt-0" onClick={() => onCommentClick(comment)}>
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="text-xs text-muted-foreground">
                          Time: {new Date(comment.timeValue).toLocaleTimeString()}
                        </div>
                      </div>
                    </CardContent>
                  </Card>
