                                ...
                                {orderedFields.map((field, index) => (
                                  <th
                                    ...
                                    style={{
                                      ...
                                      backgroundColor:
                                        index === 0
                                          ? workspaceSettings.settings.tableHeaderStyle === "colored"
                                            ? getHeaderBackgroundColor(workspaceSettings.settings.headerBackgroundColor)
                                            : "var(--muted)"
                                          : workspaceSettings.settings.tableHeaderStyle === "colored"
                                            ? getHeaderBackgroundColor(workspaceSettings.settings.headerBackgroundColor)
                                            : undefined,
                                      color:
                                        workspaceSettings.settings.tableHeaderStyle === "colored"
                                          ? getHeaderTextColor(workspaceSettings.settings.headerBackgroundColor)
                                          : undefined,
                                      padding:
...
function getHeaderBackgroundColor(colorPreset: string): string {
  switch (colorPreset) {
    case "slate":
      return "#f1f5f9"
    case "emerald":
...
function getHeaderTextColor(colorPreset: string): string {
  switch (colorPreset) {
    case "slate":
      return "#0f172a"
    case "emerald":
