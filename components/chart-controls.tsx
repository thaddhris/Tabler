...
import { ZoomIn, ZoomOut, BarChart3, LineChart, SplitSquareHorizontal, Download } from "lucide-react"

export type ChartMode = "single-axis-on" | "single-axis-off" | "split"
    ...
    <div className="flex items-center gap-4 p-4 border-b bg-background/50">
      ...
      <div className="flex items-center gap-2">
        ...
        <ToggleGroup type="single" value={mode} onValueChange={onModeChange}>
          ...
          <ToggleGroupItem value="single-axis-off" aria-label="Single without Axis">
            <BarChart3 className="h-4 w-4" />
            <span className="ml-1 text-xs">Single (Axis OFF)</span>
          </ToggleGroupItem>
